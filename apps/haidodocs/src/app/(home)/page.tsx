...
const screenshots = [
  ...
  {
    src: "/screenshots/03_products.png",
    alt: "Gestion de productos",
    label: "Catalogo",
    badge: "Admin",
  },
  {
    src: "/screenshots/06_orderHistory.png",
    alt: "Historial de pedidos",
    label: "Historial",
    badge: "Reports",
  },
  {
    src: "/screenshots/07_aeatInvoices.png",
    alt: "Facturas AEAT",
    label: "VERI*FACTU",
    badge: "AEAT",
  },
  {
    src: "/screenshots/12_themes.png",
    alt: "Temas disponibles",
    label: "Temas",
    badge: "UX",
  },
];
            ...
            <div className="space-y-8">
              ...
              >
                <div className="terminal-container max-w-md glow-border">
                  <div className="terminal-header">
                    ...
                    <span className="ml-3 text-xs text-[var(--text-subtle)] font-mono">
                      bash
                    </span>
                  </div>
              ...
              >
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-2 text-sm text-[var(--text-subtle)]"
                  >
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-lg text-[var(--text-muted)] leading-relaxed">
              Cada pantalla optimizada para operaciones rapidas. Interfaz tactil
              pensada para el ritmo intenso de la hosteleria.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            {screenshots.map((screenshot, index) => (
              ...
              >
                ...
                {/* Image */}
                <div
                  className={`relative ${index === 0 ? "aspect-[16/10]" : "aspect-video"}`}
                >
                  <Image
                    src={screenshot.src}
                    alt={screenshot.alt}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <p className="text-lg text-[var(--text-muted)] leading-relaxed mb-8">
                Un sistema completo de punto de venta pensado especificamente
                para las necesidades de la hosteleria española.
              </p>
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[var(--text-muted)] mb-12 max-w-2xl mx-auto leading-relaxed">
              Prueba la version web directamente en tu navegador. Sin
              instalacion, sin registro. O descarga la app de escritorio para
              maximo rendimiento.
            </p>
