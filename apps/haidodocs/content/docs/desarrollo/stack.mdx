...
Cliente HTTP al daemon tickmaster (externo en RPI):

| Dependencia | Uso |
|-------------|-----|
| @mks2508/tickmaster/sdk | Cliente HTTP al daemon tickmaster en RPI |
| — | (Daemon corre en RPI, no es sidecar del TPV) |
