...
export const demoOrders: Order[] = [
  // Facturas ACEPTADAS
  {
    ...
    status: 'paid',
    items: [
      { id: 1, name: 'Café con leche', price: 1.80, quantity: 2, category: 'Cafetería' },
      { id: 2, name: 'Tostada con tomate', price: 2.50, quantity: 2, category: 'Desayunos' },
      { id: 3, name: 'Zumo de naranja', price: 3.00, quantity: 1, category: 'Bebidas' },
      { id: 4, name: 'Menú del día', price: 14.90, quantity: 2, category: 'Menús' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      taxBreakdown: [
        { rate: 10, baseAmount: 41.36, taxAmount: 4.14 },
      ],
    },
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 5, name: 'Cerveza Mahou', price: 2.50, quantity: 4, category: 'Bebidas' },
      { id: 6, name: 'Tabla de ibéricos', price: 18.90, quantity: 1, category: 'Raciones' },
      { id: 7, name: 'Croquetas caseras', price: 8.50, quantity: 2, category: 'Raciones' },
      { id: 8, name: 'Tortilla española', price: 12.00, quantity: 1, category: 'Raciones' },
      { id: 9, name: 'Patatas bravas', price: 6.50, quantity: 2, category: 'Raciones' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      invoiceStatus: 'accepted',
      taxBreakdown: [
        { rate: 10, baseAmount: 71.09, taxAmount: 7.11 },
      ],
    },
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 10, name: 'Menú degustación', price: 45.00, quantity: 2, category: 'Menús' },
      { id: 11, name: 'Vino Rioja Reserva', price: 28.00, quantity: 1, category: 'Vinos' },
      { id: 12, name: 'Postre del día', price: 6.50, quantity: 2, category: 'Postres' },
      { id: 13, name: 'Café', price: 1.50, quantity: 2, category: 'Cafetería' },
      { id: 14, name: 'Copa de cava', price: 4.90, quantity: 4, category: 'Bebidas' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      invoiceStatus: 'accepted',
      taxBreakdown: [
        { rate: 10, baseAmount: 142.55, taxAmount: 14.25 },
      ],
    },
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 15, name: 'Bocadillo de calamares', price: 8.50, quantity: 2, category: 'Bocadillos' },
      { id: 16, name: 'Refresco', price: 2.20, quantity: 2, category: 'Bebidas' },
      { id: 17, name: 'Café cortado', price: 1.50, quantity: 2, category: 'Cafetería' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      invoiceStatus: 'accepted',
      taxBreakdown: [
        { rate: 10, baseAmount: 29.45, taxAmount: 2.95 },
      ],
    },
  },
  ...
  // Facturas PENDIENTES
  {
    ...
    status: 'paid',
    items: [
      { id: 18, name: 'Ensalada César', price: 9.90, quantity: 1, category: 'Ensaladas' },
      { id: 19, name: 'Agua mineral', price: 1.80, quantity: 2, category: 'Bebidas' },
      { id: 20, name: 'Tarta de queso', price: 5.50, quantity: 1, category: 'Postres' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      taxBreakdown: [
        { rate: 10, baseAmount: 21.55, taxAmount: 2.15 },
      ],
    },
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 21, name: 'Paella valenciana', price: 14.90, quantity: 2, category: 'Arroces' },
      { id: 22, name: 'Sangría jarra', price: 12.00, quantity: 1, category: 'Bebidas' },
      { id: 23, name: 'Pan con alioli', price: 3.50, quantity: 2, category: 'Entrantes' },
      { id: 24, name: 'Flan casero', price: 4.50, quantity: 2, category: 'Postres' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      invoiceStatus: 'pending',
      taxBreakdown: [
        { rate: 10, baseAmount: 61.18, taxAmount: 6.12 },
      ],
    },
  },
  ...
  // Factura RECHAZADA
  {
    ...
    status: 'paid',
    items: [
      { id: 25, name: 'Solomillo a la plancha', price: 18.90, quantity: 2, category: 'Carnes' },
      { id: 26, name: 'Vino tinto copa', price: 4.50, quantity: 4, category: 'Vinos' },
      { id: 27, name: 'Ensalada mixta', price: 6.90, quantity: 2, category: 'Ensaladas' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      taxBreakdown: [
        { rate: 10, baseAmount: 81.73, taxAmount: 8.17 },
      ],
    },
  },
  ...
  // Pedidos SIN FACTURAR
  {
    ...
    status: 'paid',
    items: [
      { id: 28, name: 'Caña de cerveza', price: 1.80, quantity: 4, category: 'Bebidas' },
      { id: 29, name: 'Pincho de tortilla', price: 2.50, quantity: 2, category: 'Pinchos' },
    ],
  ...
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 30, name: 'Hamburguesa completa', price: 10.90, quantity: 2, category: 'Hamburguesas' },
      { id: 31, name: 'Patatas fritas', price: 3.50, quantity: 2, category: 'Guarniciones' },
    ],
    // Sin información AEAT = no facturado
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 32, name: 'Pizza margarita', price: 11.50, quantity: 2, category: 'Pizzas' },
      { id: 33, name: 'Coca-Cola', price: 2.50, quantity: 2, category: 'Bebidas' },
      { id: 34, name: 'Tiramisú', price: 5.90, quantity: 2, category: 'Postres' },
      { id: 35, name: 'Café americano', price: 2.00, quantity: 2, category: 'Cafetería' },
    ],
    // Sin información AEAT = no facturado
  },
  ...
  // Más facturas aceptadas para llenar estadísticas
  {
    ...
    status: 'paid',
    items: [
      { id: 36, name: 'Entrecot', price: 22.90, quantity: 2, category: 'Carnes' },
      { id: 37, name: 'Vino Ribera del Duero', price: 32.00, quantity: 1, category: 'Vinos' },
      { id: 38, name: 'Gazpacho', price: 5.50, quantity: 2, category: 'Entrantes' },
      { id: 39, name: 'Crema catalana', price: 5.90, quantity: 2, category: 'Postres' },
      { id: 40, name: 'Chupito', price: 3.00, quantity: 4, category: 'Bebidas' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      invoiceStatus: 'accepted',
      taxBreakdown: [
        { rate: 10, baseAmount: 113.18, taxAmount: 11.32 },
      ],
    },
  },
  {
    ...
    status: 'paid',
    items: [
      { id: 41, name: 'Pulpo a la gallega', price: 16.90, quantity: 2, category: 'Mariscos' },
      { id: 42, name: 'Albariño', price: 22.00, quantity: 1, category: 'Vinos' },
      { id: 43, name: 'Pimientos de padrón', price: 7.50, quantity: 2, category: 'Raciones' },
      { id: 44, name: 'Filloas', price: 5.90, quantity: 2, category: 'Postres' },
    ],
    aeat: {
      invoiceSent: true,
      ...
      invoiceStatus: 'accepted',
      taxBreakdown: [
        { rate: 10, baseAmount: 86.91, taxAmount: 8.69 },
      ],
    },
  },
];
