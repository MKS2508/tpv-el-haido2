...
const OptimizedProductCard: React.FC<OptimizedProductCardProps> = ({
    ...
    const getCategoryColors = (category: string | undefined) => {
        ...
        if (categoryLower.includes("bebida") || categoryLower.includes("drink") || categoryLower.includes("refresco")) {
        ...
        if (categoryLower.includes("entrante") || categoryLower.includes("starter") || categoryLower.includes("tapa")) {
    ...
    const getCardStyles = () => {
        const baseStyles = "product-card relative flex flex-col overflow-hidden rounded-xl cursor-pointer";
        ...
        return cn(
            baseStyles,
            "border bg-card",
            "border-border shadow-sm manage-mode",
            className
        );
    };
