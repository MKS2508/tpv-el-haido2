...
import { Check, ChevronDown, Moon, Sun, Monitor, Loader2 } from "lucide-react"
...
export function ThemeSwitcher() {
  ...
  const [previousMode, setPreviousMode] = useState<"light" | "dark">((resolvedTheme as "light" | "dark") || "dark")
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      <span
                        ...
                        style={{
                          background: theme.value === colorTheme ? `hsl(var(--primary))` : `hsl(var(--muted))`,
                          boxShadow: "0 0 0 1px hsl(var(--border))",
                        }}
                      />
