    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <Input id="price" type="number" step="0.01" value={price} onChange={(e) => setPrice(parseFloat(e.target.value))}
                       required/>
            </div>
            <div>
            ...
            <div>
                ...
                <div className="flex space-x-2">
                    <Button type="button" variant={iconType === 'preset' ? 'default' : 'outline'}
                            onClick={() => setIconType('preset')}>
                        Preestablecido
                    </Button>
                    <Button type="button" variant={iconType === 'upload' ? 'default' : 'outline'}
