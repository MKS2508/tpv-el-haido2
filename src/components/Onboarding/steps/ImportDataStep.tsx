    ...
    <Card class="w-full max-w-2xl mx-auto border-none shadow-2xl bg-background/60 backdrop-blur-xl">
      ...
      <CardContent class="space-y-6">
          ...
          fallback={
            <div class="grid md:grid-cols-2 gap-6">
              ...
              <div class="space-y-4 flex flex-col">
                ...
                <p class="text-sm text-muted-foreground">
                  ¿Solo quieres probar? Carga nuestra base de datos de ejemplo con productos,
                  categorias y mesas preconfiguradas.
                </p>
        ...
        <div class="rounded-lg bg-yellow-500/10 border border-yellow-500/20 p-4 flex items-start gap-3">
          ...
          <p class="text-sm text-yellow-700 dark:text-yellow-500">
            <strong>Paso opcional:</strong> Si prefieres configurar todo desde cero despues de
            completar el asistente, puedes saltar este paso.
          </p>
        </div>
      </CardContent>
      <CardFooter class="flex justify-between border-t p-6 bg-muted/20">
        ...
        <div class="flex gap-3">
          ...
          <Show when={props.importedData} fallback={<Button disabled>Continuar</Button>}>
