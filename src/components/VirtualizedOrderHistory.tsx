import { CheckCircle, CreditCard, HandCoins, Loader2, XCircle } from 'lucide-react';
...
const VirtualizedOrderHistory: React.FC<VirtualizedOrderHistoryProps> = ({
  ...
  // Si no hay órdenes
  if (orders.length === 0) {
    return <div className="text-center text-muted-foreground py-8">No hay pedidos que mostrar</div>;
  }
