...
export const useThermalPrinterOptions = () => useStoreSelector(state => state.thermalPrinterOptions)
...
export const useTouchOptimizationsEnabled = () => useStoreSelector(state => state.touchOptimizationsEnabled)
...
export const useSetThermalPrinterOptions = () => useStoreSelector(state => state.setThermalPrinterOptions)
...
export const useSetTouchOptimizationsEnabled = () => useStoreSelector(state => state.setTouchOptimizationsEnabled)
...
export const useOrderStats = () => useStoreSelector(state => {
...
export const useAppData = () => useStoreSelector(state => ({
  users: state.users,
...
export const useHomeData = () => useStoreSelector(state => ({
  orderHistory: state.orderHistory
}))

// Para Products.tsx - Solo productos y categorías
export const useProductsData = () => useStoreSelector(state => ({
  users: state.users,
  selectedUser: state.selectedUser,
  products: state.products,
  setProducts: state.setProducts,
...
export const useNewOrderData = () => useStoreSelector(state => ({
...
export const useOrderHistoryData = () => useStoreSelector(state => ({
  orderHistory: state.orderHistory,
  activeOrders: state.activeOrders,
  setOrderHistory: state.setOrderHistory
}))